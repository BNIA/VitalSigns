...
From there, you can go on to do even greater things using our [dataplay](https://github.com/BNIA/dataplay) library.
...
You can pull Maryland Foreclosure data from the courts database using this:
...
The output may have street names that need cleaning. You can seamlessly pipe the output from close crawl into our TidyAddr script.  
...
From there you can take these datasets and start to visualize them. Enjoy what you've seen so far? 

Check out our Dataplay and Dataguide libraries for tutorials and functions to work with the data!
...
The following instructions will help you if you'd like to update or work on this repo.
...
Included below are single line functions that help contributers with publication of their changes.

Please consult the NBDEV chapter in our [dataguide](https://github.com/BNIA/dataguide/blob/main/notebooks/06_Nbdev.ipynb) for more instructions.
...
# step 3
project = 'VitalSigns'
token = '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' 
username = 'BNIA'
...
```
    ...
    https://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@github.com/BNIA/VitalSigns.git
    Counting objects: 8, done.
    Delta compression using up to 2 threads.
    Compressing objects: 100% (8/8), done.
    Writing objects: 100% (8/8), 1.83 KiB | 625.00 KiB/s, done.
    Total 8 (delta 6), reused 0 (delta 0)
    remote: Resolving deltas: 100% (6/6), completed with 3 local objects.[K
    To https://github.com/BNIA/VitalSigns.git
       f6e6ed0..225e809  main -> main
